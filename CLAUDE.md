...
5. Read the skill files — canonical copies live in the XeedlyAI library at `..\standards` (this repo no longer carries local copies):
...
At minimum, read `projects/Sovvrn.md` before starting work.
